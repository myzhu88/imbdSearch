...
-Run application:
	...
	4) If a prompt comes up for how would you like to open this application, choose a web browser of your 
	   preference.
...
-Troubleshooting:
	...
	-If a web browser does not automatically open after running the "gulp" command, please open a web browser 
